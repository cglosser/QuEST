...
BOOST_AUTO_TEST_CASE(full_constructor_d0)
{
  constexpr int order = 5;
  constexpr double eval_point = 0.5;
  const std::vector<double> compare_array = {63.0/256, 315.0/256, -105.0/128,
					     63.0/128, -45.0/256, 7.0/256};
...
BOOST_AUTO_TEST_CASE(full_constructor_d1)
{
  constexpr int order = 5;
  constexpr double eval_point = 0.5;
  const std::vector<double> compare_array = {-563.0/640, 67.0/128, 143.0/192,
					     -37.0/64, 29.0/128, -71.0/1920};
...
BOOST_AUTO_TEST_CASE(full_constructor_d2)
{
  constexpr int order = 5;
  constexpr double eval_point = 0.5;
  const std::vector<double> compare_array = {95.0/48, -269.0/48, 49.0/8,
					     -85.0/24, 59.0/48, -3.0/16};
